...
namespace ASP.NET1.Controllers
{
    public class HomeController : Controller
    {
        ...
        { 
            if (!System.IO.File.Exists(@"C:\Users\ANNEVASE\OneDrive - Capgemini\Desktop\lighthouse.jfif"))
            {
                return Content("File to be downloaded not found");
            }
            return File(@"C:\Users\ANNEVASE\OneDrive - Capgemini\Desktop\lighthouse.jfif", "image/jpg", "default.jpg");
        }
